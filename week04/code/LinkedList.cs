...
public class LinkedList : IEnumerable<int>
{
    ...
    public void Remove(int value)
    {
        ...
        while (curr is not null)
        {
            if (curr.Data == value)
            {
                ...
                // If the location of 'value' is at the begining of the list,
                // then we can call remove_head to remove the 'value'
                else if (curr == _head)
                {
                    RemoveHead();
                }
                ...
                {
                    curr.Next!.Prev = curr.Prev; // Connect node after 'value' to the previous node
                    curr.Prev!.Next = curr.Next; // Connect the node containing 'value' to the next node
                }
    ...
    public void Replace(int oldValue, int newValue)
    {
        ...
        while (curr is not null)
        {
            // If the current data found in the list is equal to the search datd(oldValue)
            if (curr.Data == oldValue)
            {
                // then change it to the newValue
                curr.Data = newValue;
            }
